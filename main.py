...
def tela(r, g, b, temperatura, condicao, sensacao, min, max):
    ...
    t.color('black')
    t.clear()
    t.write(temperatura, align='center', font=('Comic Sans MS', 30, 'normal'))
    t.goto(-100, 0)
    t.color('black')
    t.write(condicao, align='center', font=('Comic Sans MS', 15, 'normal'))
    t.goto(-100, 30)
    t.color('black')
    t.write(cidade, align='center', font=('Comic Sans MS', 15, 'normal'))
    t.goto(-100, -30)
    t.color('black')
    t.write(sensacao, align='center', font=('Comic Sans MS', 7, 'normal'))
    t.goto(60, -30)
    t.color('black')
    t.write(min, align='center', font=('Comic Sans MS', 7, 'normal'))
    t.goto(120, -30)
    t.color('black')
    t.write(max, align='center', font=('Comic Sans MS', 7, 'normal'))
    t.goto(0, -70)
    t.color('black')
...
min = ' '
max = ' '
tela(252, 163, 17, temperatura, condicao, sensacao, min, max)
